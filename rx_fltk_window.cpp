	...
	: Fl_Double_Window(w_, h_, title), m_iWinX(100), m_iWinY(100), m_iWinW(w_), m_iWinH(h_)
{
...

	{
		...
		m_pMenuBar->add("Particle/Color/HighClstr",	  FL_CTRL+FL_SHIFT+'w', rxFlGLWindow::OnMenuParticle_s, m_pGLCanvas, FL_MENU_RADIO);	//追加		
...
void rxFlWindow::UpdateMenuState(void)
{
	...
	SetMenuItemState(m_pMenuBar, "Particle/Color/HighClstr",		(m_pGLCanvas->m_iColorType == rxParticleSystemBase::RX_ICE_HIGH_CLUSTER));	//追加	
