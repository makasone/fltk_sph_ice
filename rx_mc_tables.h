...
#ifndef _RX_MC_TABLES_H_
#define _RX_MC_TABLES_H_



// どのエッジが等値面と交差しているかを示す12ビット数を示す．
// 等値面内にある頂点を1とした8ビットフラグから参照する．
...
// 三角形メッシュテーブル
//  - エッジ上の等値面頂点の位置を示す8ビットフラグから
//    最大5三角形のリストのグリッド内頂点インデックスを示すテーブル
#define X 255
const unsigned int triTable[256][16] = {
